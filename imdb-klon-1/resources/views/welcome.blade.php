...
<x-app-layout>
    ...
    <div class="sm:fixed sm:top-8 sm:right-4 p-6 text-right z-10">
        ...
        <a href="{{ url('/profile') }}" style="font-size: 15px; color: white !important; text-decoration: none !important;" class="font-semibold hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline-none focus:outline-2 focus:rounded-sm focus:outline-red-500">Profile</a>
        @elseif(auth()->user()->role === 'admin')
        <a href="{{ route('dashboard.index') }}" style="font-size: 15px; color: white !important; text-decoration: none !important;" class="font-semibold hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline-none focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
        @endif
        @else
    ...
    <h3 class="h1-home" style="margin-left: 10px;">
        ...
        <a href="{{ route('movies.index') }}" class="btn btn-primary text-xl lg:text-2xl mt-4 bg-red-950">All Movies</a>
    </h3>
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <img src="https://m.media-amazon.com/images/S/pv-target-images/af5f3bfd605bcf60c762eee7cc2f94d6bd3c1514573440c4cd28126c662e3820._UR1920,1080_BR-6_SX720_FMpng_.png" alt="Up Graded" class="imgMovie" style="width:100%; ">
            </div>

            <div class="item">
                <img src="https://m.media-amazon.com/images/S/pv-target-images/c9a768bbc37d687ae0a7b654823149a383f881c9b2f11ef26a653f5932e5902f._UR1920,1080_BR-6_SX720_FMjpg_.jpg" alt="Before I Fall" class="imgMovie" style="width:100%; ">
            </div>

            <div class="item">
                <img src="https://m.media-amazon.com/images/S/pv-target-images/9e90d3e659f8afecc25a3805bb4bbcb1ade262ce2f4553b4790181ed75305e09._UR1920,1080_BR-6_SX720_FMjpg_.jpg" alt="The Burge" class="imgMovie" style="width:100%;">
            </div>

            <div class="item">
                <img src="https://m.media-amazon.com/images/S/pv-target-images/1b2cb0767387e87857d7a78684502fcda060fde0fbe22d702c9a3c29925106d3._UR1920,1080_BR-6_SX720_FMjpg_.jpg" alt="Invetation" class="imgMovie" style="width:100%; ">
            </div>

            <div class="item">
                <img src="https://m.media-amazon.com/images/S/pv-target-images/ed15ec716998dcba6bb9bc04d00507d9949cfd17bea35497e6282827c5a0b3e0._UR1920,1080_BR-6_SX720_FMjpg_.jpg" alt="Mid Sommar" class="imgMovie" style="width:100%;">
            </div>
        </div>
    ...
    <div class="wrapper">
        <div class="owlcarousel owl-carousel">
            <div class="card card-1">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/iiid1xMhoAcW83VJ9LdAqf4Vtbr.jpg" alt="Card image cap">
            </div>
            <div class="card card-2">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/8b8R8l88Qje9dn9OE8PY05Nxl1X.jpg" alt="Card image cap">
            </div>
            <div class="card card-3">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/yG8QKnaiz7JoIMh3oxdm0JJN6IG.jpg" alt="Card image cap">
            </div>
            <div class="card card-4">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/UZ0ydgbXtnrq8xZCI5lHVXVcH9.jpg" alt="Card image cap">
            </div>
            <div class="card card-5">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/k6iHs4daxm0RQqFQsE8oE5wWJjj.jpg" alt="Card image cap">
            </div>
            <div class="card card-5">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/uQkiDKQyun13mqsOXv7I5MRKr0q.jpg" alt="Card image cap">
            </div>
            <div class="card card-5">
                <img src="https://media.themoviedb.org/t/p/w600_and_h900_bestv2/46sp1Z9b2PPTgCMyA87g9aTLUXi.jpg" alt="Card image cap">
            </div>
