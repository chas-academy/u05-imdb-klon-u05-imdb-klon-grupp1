    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
      ...
      <form action="{{ route('dashboard.movies.store') }}" method="POST" class="space-y-4">
        ...
        <div>
          ...
          <input type="date" name="release_date" id="release_date" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
        </div>
